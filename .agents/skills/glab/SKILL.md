...
When creating comments or notes, prefix with your name (CLAUDE) and Emoji for clarity:

```bash
glab mr note 123 -m "🦀 CLAUDE: Please update tests"
```

This doesn't apply for merge request titles or descriptions, only for comments on existing MRs or issues.
